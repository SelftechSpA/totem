...
$(document).ready(function(){
    preload(['themes/totem/images/juego/fondo.jpg', 
             'themes/totem/images/juego/noise.gif', 
             'themes/totem/images/juego/1.png', 
             'themes/totem/images/juego/2.png', 
             'themes/totem/images/juego/3.png', 
             'themes/totem/images/juego/4.png', 
             'themes/totem/images/juego/5.png', 
             'themes/totem/images/juego/6.png', 
             'themes/totem/images/juego/7.png', 
             'themes/totem/images/juego/8.png', 
             'themes/totem/images/juego/9.png', 
             'themes/totem/images/juego/10.png', 
             'themes/totem/images/juego/11.png',
             'themes/totem/images/juego/interior.gif', 
             'themes/totem/images/juego/lineas_der.gif', 
             'themes/totem/images/juego/lineas_izq.gif']);
    ...
    $('.spinedit i').addClass('icon-white');
...
function addObstacle(){
	...
	//tl.fromTo(obstacle, obstacleSpeed, {rotation:0, scaleX:6, scaleY:6}, {scaleX:10, scaleY:10}, '-=0.0');
    tl.fromTo(obstacle, obstacleSpeed, {rotation:0, scaleX:8, scaleY:8}, {scaleX:10, scaleY:10}, '-=0.0');
    obstacle.show();
	if(carPosition == RIGHT){
		tl.fromTo(obstacle, obstacleSpeed, {x:-280, y:50}, {x:-180, y:460, ease: Power2.easeIn}, '-=0.550')/*.call(function(position){
		   return function(){
			  checkCrash(position);
		   };
		}(carPosition))*/;
		...
		tl.fromTo(obstacle, obstacleSpeed, {x:-130, y:50}, {x:-360, y:460, ease: Power2.easeIn}, '-=0.550')/*.call(function(position){
		   return function(){
			  checkCrash(position);
		   };
		}(carPosition))*/;
...
function checkCrash(position){
	...
	if(reactionTime > (obstacleSpeed + timeOffset)*1000){
		...
		if(position == RIGHT){
			tl.to(obstacle, obstacleSpeed, {rotation:100, x:1000, y: 100, ease: Power2.easeOut});
		}else{
			tl.to(obstacle, obstacleSpeed, {rotation:-100, x:-1400, y: 100, ease: Power2.easeOut});
		}
		...
		//no chocaste
		if(position == RIGHT){
			tl.to(obstacle, obstacleSpeed/3, {x:120, y:500});
		}else{
			tl.to(obstacle, obstacleSpeed/3, {x:-230, y:500});
		}
