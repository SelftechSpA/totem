...
class Mail extends CWidget {
    ...
    public function init() {
        ...
        $this->mail->Username = 'alertasreaccion@gmail.com';
        //$this->mail->Username = 'felipe.huerta.iturra@gmail.com';
        $this->mail->Password = 'selfishnessalertas';
        //$this->mail->Password = 'Racyle0664';
        $this->mail->Mailer = 'smtp';
        $this->mail->Port = 465;
        $this->mail->SMTPAuth = true;
        $this->mail->SMTPSecure = 'ssl';
