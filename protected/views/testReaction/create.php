...
<div class="row center" style="width: 640px; margin-bottom: 30px; position: relative;">
    ...
    <div id="game-container">
        ...
        <div id="intro">
            ...
            <br>
            <br>
            <button type="button" id="introButton" class="btn btn-danger">Continuar</button>
        </div>
    	<div id="gameOver">Test finalizado. Espere por favor...</div>
    	<div id="play">
    	    <h1 style="margin-top: 0px;">Antes de empezar...</h1>            
    	    <label>¿Cuántas horas durmió anoche?</label>
    	    <input type="text" name="horas_sueno" id="horas_sueno" class="spinEditHoras"><br><br>
    	    <label>¿Cuántas horas hace que está despierto?</label>
    	    <input type="text" name="horas_despierto" id="horas_despierto" class="spinEditHoras"><br><br>
    	    ...
    	    <br><br>
    	    <br><br>
    	    <button type="button" id="instructionsButton" class="btn btn-danger">Continuar</button>
    	</div>
    	<div id="instructions">
            <h1>Instrucciones</h1>
            ...
            <button type="button" id="playButton" class="btn btn-danger">Comenzar</button>
    	</div>
    </div>
